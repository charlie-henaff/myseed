...
const spotify_web_player_req_scopes = 'streaming user-read-email user-read-private';
const spotify_playlist_req_scopes = 'user-top-read';
const spotify_player_req_scopes = 'user-read-playback-state user-modify-playback-state';

const spotify_client_scopes = spotify_web_player_req_scopes
    .concat(' ', spotify_playlist_req_scopes)
    .concat(' ', spotify_player_req_scopes);
